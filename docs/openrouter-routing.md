...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `qwen/qwen3-coder` | CLI workflow generation, command review, and provider-cost summaries. |
...
OPENROUTER_HTTP_REFERER=https://multi-cli-pilot.pages.dev
OPENROUTER_APP_TITLE=multi-cli-pilot
```
