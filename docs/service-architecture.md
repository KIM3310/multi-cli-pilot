# Service Architecture - multi-cli-pilot
...
- **Lane:** Controlled CLI automation
- **Primary buyer:** Platform teams testing safe AI-assisted internal workflows
- **First motion:** Workflow safety review and dry-run automation prototype

## Recommended Architecture

CLI-first repo with static docs, optional private sandbox runner on container platform, audit log storage if used in pilots.
