...
- Scope: credential-free synthetic demo surface for quick architecture-reader inspection.
...
Multi-agent orchestration harness for CLI coding agents (Gemini, Qwen) -- prompts, workflows, team coordination, MCP, HUD.
