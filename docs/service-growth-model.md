# Service Growth Model - multi-cli-pilot
...
| Field | Decision |
|---|---|
| Service type | Controlled CLI automation |
| Primary reader or buyer | Platform teams testing safe AI-assisted internal workflows. |
| Wedge | Workflow safety review and dry-run automation prototype. |
